  ...
  return (
    <div className="flex flex-col  pt-12 ">
      <div className="flex">
        ...
        {showFilterMenu && (
          <div className="flex pl-6  animate-[opening_1s_ease-in-out] flex-col w-[70%] h-screen p-4 absolute bg-[#D9D9D9] rounded-sm ">
            <BsChevronLeft size={20} color="#000000" onClick={closeMenu} />
          ...
          products.map((x) => (
            ...
            >
              ...
              <div className="flex justify-items-center items-center">
                <p className="text-[#7a7a7a] pr-3">${x.price}</p>
                <BsCartPlus
